        ...
        <section class="mt-5 wow fadeIn">
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    <p style="font-weight: bold; text-align: right; color: #DC0E13; font-size: xx-large">Motor:</p>
                    <p style="font-weight: bold; text-align: right; color: #DC0E13; font-size: xx-large">Ime:</p>
                    <p style="font-weight: bold; text-align: right; color: #DC0E13; font-size: xx-large">Gorivo:</p>
                </div>
                <div class="col-md-6 mb-4">
                    <p style="font-weight: bold; color: #212529; font-size: xx-large">{{ $formula->engine}}</p>
                    <p style="font-weight: bold; color: #212529; font-size: xx-large">{{ $formula->name}}</p>
                    <p style="font-weight: bold; color: #212529; font-size: xx-large">{{ $formula->fuel}}</p>
                </div>
                <!--Grid column-->
{{--                <div class="col-md-6 mb-4">--}}
